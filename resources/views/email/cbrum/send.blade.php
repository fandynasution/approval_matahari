                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px">
                                    ...
                                    <p style="text-align:left;margin-bottom: 15px; color: #000000; font-size: 16px;">Below is a cash advance settlement that requires your approval :</p>
                                    <p style="text-align:left; margin-bottom: 15px; margin-top: 0; color: #000000; font-size: 16px; list-style-type: circle;">
                                        <b>{{ $dataArray['remarks_hd'] }}</b><br>
                                        With a total amount of {{ $dataArray['currency_cd'] }} {{ $dataArray['total_amt'] }}<br>
                                        Doc No.: {{ $dataArray['replenish_doc'] }}<br>
                                    </p>
